  ...
  return (
    <Card className="overflow-hidden transition-all hover:shadow-lg">
      <div className="relative h-48 w-full overflow-hidden">
        ...
        />
        <Badge className="absolute top-2 right-2 bg-primary">{car.year}</Badge>
        <Button
          variant="ghost"
          size="icon"
      ...
      <CardContent className="p-4">
        ...
        <div className="text-2xl font-bold mb-4">${car.price.toLocaleString()}</div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <span>{car.mileage > 0 ? `${car.mileage.toLocaleString()} km` : "New"}</span>
          </div>
          <div className="flex items-center gap-2 text-sm">
